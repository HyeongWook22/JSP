...
<%@ page session="false" %>
<% System.out.println("addBook.jsp에 도착"); %>
<!DOCTYPE html>
<html>
<head>
<!-- 리소스(이미지, css, js) 경로는 절대경로를 추천 -->
<link rel = "stylesheet" href = "/bookmarket_crudd/resources/css/bootstrap.min.css" />
<script type="text/javascript" src="/bookmarket_crudd/resources/js/validation.js"></script>
<meta charset="UTF-8">
<title>도서 등록</title>
</head>
<body>
